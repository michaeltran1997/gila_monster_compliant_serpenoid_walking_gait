classdef SMComplementaryFilter < handle
    ...
    % negative z-axis
    % To do: There are some redundancies with using snakeData struct, since
    % most of that info is not used, and could be obtained/stored in other
    % ways. but it doesn't hurt to leave it as far as I can tell -Julian
    
    methods(Access = public)
        %Constructor
        function this = SMComplementaryFilter(varargin)
            %COMPLEMENTARYFILTER
            %Arguments:
            %   snakeData
            %
            ...
            this.accelVecAvg = [0;0;0];
            this.gyroVecAvg = [0;0;0];
        ...
        function gyroVecAvg = getGyroVecAvg(this)
            %returns average gyro rotational velocity vector
            gyroVecAvg = this.gyroVecAvg;
        end
        
        function accelVecAvg = getAccelVecAvg(this)
            %returns average acceleration velocity vector
            accelVecAvg = this.accelVecAvg;
        end
    ...
    methods(Access = private, Hidden = true)
        ...
        function updateFilter(this, fbk)
            ...
            this.gyroVecAvg = gyroVecAvg;
            this.accelVecAvg = accelVecAvg;
